...
_BUILTIN_REQUIREMENTS: Dict[str, Callable[[], bool]] = {
    ...
    "gemini": lambda: bool(_resolve_provider_key("GOOGLE_AI_API_KEY", "gemini") or _resolve_provider_key("GEMINI_API_KEY", "gemini") or _resolve_provider_key("GOOGLE_API_KEY", "gemini")),
